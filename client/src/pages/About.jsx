      ...
      <div className="grid grid-cols-2" style={{ alignItems: 'center', gap: '4rem' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            Welcome to Naveen Ink Studio. I am an independent artist specializing in pencil sketches, vibrant color portraits, and unique doodle art. With a passion for capturing emotions and telling stories through art, I've spent years honing my craft.
          </p>
